...
from models.pplite.stdc import STDCNet813, STDCNet1446
from models.pplite.UAFM import UAFM_SpAtten, ConvBNReLU
...
class PPLiteSeg(nn.Module):
    ...
    def __init__(self,
                 ...
                 cm_bin_sizes=[1, 2, 4],
                 cm_out_ch=128,
                 arm_out_chs=[64, 96, 128], # [32, 64, 128] for STDCNet813; [64, 96, 128] for STDCNet1446
...
def get_PPliteSeg(is_train):
    model = PPLiteSeg(num_classes=9, is_training=is_train)
    return model


if __name__ == "__main__":
    model = PPLiteSeg(num_classes=9, is_training=True)
    model.eval()
