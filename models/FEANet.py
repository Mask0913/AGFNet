...
class FEANet(nn.Module):
    ...
    def __init__(self, n_class):
        ...
        if self.num_resnet_layers == 50:
            ...
            resnet_raw_model1 = models.resnet152(pretrained=False)
            resnet_raw_model2 = models.resnet152(pretrained=False)
            self.inplanes = 2048
...
if __name__ == '__main__':
    model = FEANet(9).cuda(0)
    x = torch.randn(1, 4, 480, 640).cuda()
